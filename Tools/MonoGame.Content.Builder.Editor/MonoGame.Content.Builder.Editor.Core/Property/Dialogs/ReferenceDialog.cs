    ...
    partial class ReferenceDialog : Dialog<bool>
    {
        ...
        public ReferenceDialog(string[] refs)
        {
            ...
            foreach (var rf in refs)
                _dataStore.Add(new RefItem(Path.GetFileName(rf), Controller.GetFullPath(rf)));
        ...
        public override void Close()
        {
            ...
            while (items.MoveNext())
                References.Add(Controller.GetRelativePath(items.Current.Location));
            base.Close();
        }
        ...
        private void ButtonAdd_Click(object sender, EventArgs e)
        {
            ...
            dialog.Directory = new Uri(Controller.ProjectItem.Location);
