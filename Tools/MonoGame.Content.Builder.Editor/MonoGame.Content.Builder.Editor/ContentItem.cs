...
namespace MonoGame.Content.Builder.Editor
{
    ...
    public class ContentItem : IProjectItem
    {
        ...
        public ImporterTypeDescription Importer
        {
            ...
            set
            {
                ...
                if ((_processor == null || _processor.InputType != _importer.OutputType) && _processor != PipelineTypes.MissingProcessor)
                {
                    ...
                    Processor = PipelineTypes.FindProcessor(_importer.DefaultProcessor, _importer) ?? PipelineTypes.NullProcessor;
                }
            }
        }
        ...
        public void ResolveTypes()
        {
            ...
            {
                _importer = PipelineTypes.FindImporter(ImporterName, System.IO.Path.GetExtension(OriginalPath)) ?? PipelineTypes.NullImporter;
                ...
                _processor = PipelineTypes.FindProcessor(ProcessorName, _importer) ?? PipelineTypes.NullProcessor;
