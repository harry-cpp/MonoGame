...
namespace MonoGame.Content.Builder.Editor.Property
{
    partial class PathDialog : Dialog<bool>
    {
        ...
        private void ButtonBrowse_Click(object sender, EventArgs e)
        {
            ...
            dialog.Directory = Tools.Pipeline.PipelineController.Instance.GetFullPath(textBox1.Text);

            if (dialog.ShowDialog(this) == DialogResult.Ok)
                textBox1.Text = Tools.Pipeline.PipelineController.Instance.GetRelativePath(dialog.Directory);
        }
