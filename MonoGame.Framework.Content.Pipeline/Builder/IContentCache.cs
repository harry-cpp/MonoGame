...
public interface IContentCache
{
    ...
    ContentFileCache? ReadContentFileCache(ContentBuilder builder, string relativePath, bool shouldBuild = false, IContentImporter? importer = null, IContentProcessor? processor = null);
