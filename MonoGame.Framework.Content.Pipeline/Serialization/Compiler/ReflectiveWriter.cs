...
namespace Microsoft.Xna.Framework.Content.Pipeline.Serialization.Compiler
{
    class ReflectiveWriter<T> : ContentTypeWriter
    {
        ...
        public ReflectiveWriter() : base(typeof(T))
        {
        }
        ...
        private bool IsValidProperty(PropertyInfo property)
        {
            ...
            if (Attribute.GetCustomAttribute(property, typeof(ContentSerializerIgnoreAttribute)) is not ContentSerializerAttribute contentSerializerAttribute)
            {
        ...
        private bool IsValidField(FieldInfo field)
        {
            ...
            if (Attribute.GetCustomAttribute(field, typeof(ContentSerializerIgnoreAttribute)) is not ContentSerializerAttribute contentSerializerAttribute)
            {
                // There is no ContentSerializerAttribute, so non-public
